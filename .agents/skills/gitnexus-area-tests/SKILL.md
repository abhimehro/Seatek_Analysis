...
description: "Skill for the Tests area of Seatek_Analysis. 23 symbols across 4 files."
---
...
| File                                         | Symbols                                                                                                                                                                                                                                                |
| -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `tests/test_code_health_scanner.py`          | test_read_file_safe_happy_path, test_read_file_safe_non_existent, test_read_file_safe_null_byte, test_read_file_safe_null_byte_pathlib, test_read_file_safe_path_traversal (+7)                                                                        |
...
- **`test_read_file_safe_null_byte_pathlib`** (Function) —
  `tests/test_code_health_scanner.py:106`
...
| `test_read_file_safe_null_byte_pathlib`                                    | Function | `tests/test_code_health_scanner.py`          | 106  |
| `test_read_file_safe_path_traversal`                                       | Function | `tests/test_code_health_scanner.py`          | 60   |
| `test_read_file_safe_restricted_permissions`                               | Function | `tests/test_code_health_scanner.py`          | 116  |
...
| `setup_mock_process`                                                       | Function | `tests/test_repository_automation_common.py` | 22   |
